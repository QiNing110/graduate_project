...
if __name__ == '__main__':
    ...
    Settings.llm = Ollama(model="qwen3-14B-RAG-Instruct-32k", request_timeout=360.0)
    ...
    test_set_path = "./dataset/fictions_testset.json"
...
我是一个{role}，我的任务是{task}，我的问题是{question}
    ...
    for item in tqdm(test_set, desc="Processing items", unit="item"):
        ...
        final_res = ''
        if "</think>\n" in response_str:
            final_res = response_str.split("</think>\n")[-1]
        else:
